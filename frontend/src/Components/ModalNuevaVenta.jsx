...
const ModalNuevaVenta = ({ isOpen, onSalir, onFacturar }) => {
    ...
    console.log('ModalNuevaVenta renderizado - showConfirmarSalir:', showConfirmarSalir, 'showConfirmarFacturar:', showConfirmarFacturar);
    ...
    const handleSalir = () => {
        console.log('handleSalir llamado, articulos:', articulosSeleccionados.length);
        if (articulosSeleccionados.length > 0) {
            console.log('Mostrando modal de confirmación para salir');
            setShowConfirmarSalir(true);
        } else {
            console.log('Saliendo directamente');
            onSalir();
        }
    };

    const handleFacturar = () => {
        console.log('handleFacturar llamado');
        setShowConfirmarFacturar(true);
    };

    const confirmarSalir = () => {
        setShowConfirmarSalir(false);
        onSalir();
    };
