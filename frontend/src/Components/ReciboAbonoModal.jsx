...
const ReciboAbonoModal = ({ data, onClose }) => {
  ...
  const handleConfirmPDF = async () => {
    ...
    try {
      ...
      console.log("Generando PDF de Recibo de ABONO...");
      ...
      console.error("Error al generar PDF de Recibo de ABONO:", error);
        ...
        <div className="recibo-card-body">
          ...
          <header className="recibo-header">
            ...
            <div className="recibo-empresa-info">
              ...
              <h2 className="recibo-tipo-titulo">RECIBO DE ABONO</h2>

              <div className="recibo-top-meta">

                <p className="recibo-numero">No. {data.numero || '0002'}</p>

                <p className="recibo-fecha-destacada">FECHA: {data.fecha || '2026-04-30'}</p>
            ...
            <div className="recibo-field-large">
              ...
              <div className="recibo-value-text">
                ...
                <div style={{ color: '#111827', fontWeight: '600', fontSize: '14px' }}>
                  ...
                  Abono aplicado al registro de venta #{data.nroInterno || '---'}
...
export default ReciboAbonoModal;
